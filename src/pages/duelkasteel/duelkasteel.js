    ...
    render() {
        ...
        return (
            <Box className={classes.root}>
                ...
                <br></br>
                <div className="left">
                    <p class="scoreText">{drinks.filter(e => e.team === 'left').map(e => e.total).reduce((a,b) => a + b) + 35}x</p>
                </div>
                <div className="right">
                    <p class="scoreText">x{drinks.filter(e => e.team === 'right').map(e => e.total).reduce((a,b) => a + b) + 65}</p>
                </div>
            </Box>
