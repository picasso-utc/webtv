                    ...
                    <Grid container direction="row" style={{height: '20%'}}>
                        ...
                        <Grid item xs={3} component={StyledDiv_score}>
                            <div component={StyledLeft_score} id="delirium">
                                <img alt="deli_score" src={asset_url("/images/beer.gif")} component={StyledLeft_score_img}/>
                            </div>
                        </Grid>
                        <Grid item xs={3} component={StyledDiv_score}>
                            <div component={StyledRight_score} id="cuvee">
                                <img alt="cuvee_score" src={asset_url("/images/beer.gif")} component={StyledRight_score_img}/>
                            </div>
                        </Grid>
                    ...
                    <Grid container direction="row" style={{height: '20%'}}>
                        ...
                        <Grid item xs={3} component={StyledDiv_score}>
                            <div component={StyledLeft_score} id="delinoel">
                                <img alt="delinoel_score" src={asset_url("/images/beer.gif")} component={StyledLeft_score_img}/>
                            </div>
                        </Grid>
                        <Grid item xs={3} component={StyledDiv_score}>
                            <div component={StyledRight_score} id="bush">
                                <img alt="bush_score" src={asset_url("/images/beer.gif")} component={StyledRight_score_img}/>
                            </div>
                        </Grid>
                        <Grid item xs={3} component={StyledImg_div_right}>
                    ...
                    <Grid container direction="row" style={{height: '20%'}}>
                        ...
                        <Grid item xs={3} component={StyledDiv_score}>
                            <div component={StyledLeft_score} id="argentum">
                                <img alt="argentum_score" src={asset_url("/images/beer.gif")} component={StyledLeft_score_img}/>
                            </div>
                        </Grid>
                        <Grid item xs={3} component={StyledDiv_score}>
                            <div component={StyledRight_score} id="surfine">
                                <img alt="surfine_score" src={asset_url("/images/beer.gif")} component={StyledRight_score_img}/>
                            </div>
                        </Grid>
                        <Grid item xs={3} component={StyledImg_div_right}>
